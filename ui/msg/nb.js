...
//with no label at all.
  ...
  math_max_of: "maks av",
  math_and: "og",
  math_min_tooltip: "Returnerer den minste av de to verdiene.",
  math_max_tooltip: "Returnerer den største av de to verdiene.",
  sht20_temperature: "SHT20-temperatur",
  sht20_humidity: "SHT20-fuktighet",
  mqtt_init: "Start MQTT-klient",
  mqtt_start: "Start MQTT-klient",
  server_address: "Serveradresse",
  server_port: "Serverport",
  username: "Brukernavn",
  password: "Passord",
  mqtt_add_to_buffer: "Legg data i MQTT-bufferet",
  field_name: "Feltnavn",
  value: "Verdi",
  mqtt_publish_buffer: "Publiser bufferet til MQTT-emne",
  mqtt_publish_payload: "Publiser data til MQTT-emne",
  mqtt_topic: "Emne",
  payload: "Data",
  qos: "QOS:",
  mqtt_most_once: "0 - høyst én gang",
  mqtt_least_once: "1 - minst én gang",
  mqtt_set_callback: "Sett tilbakekall for MQTT-meldinger",
  mqtt_callback_tooltip: "Tilbakekallsfunksjonen må ta parameterne topic og msg.",
  with: "med",
  received_from: "mottatt fra",
  do: "gjør",
  mqtt_subscribe: "Abonner på MQTT-emne",
  mqtt_check_msg: "Se etter ventende meldinger på MQTT-serveren",
  mqtt_check_msg_tooltip: "Sjekker om serveren har ventende meldinger. Ikke-blokkerende. Abonnementsmeldinger sendes til tilbakekallet.",
  mqtt_wait_msg: "Vent på meldinger fra MQTT-serveren",
  mqtt_wait_msg_tooltip: "Venter til serveren sender en melding. Blokkerende. Abonnementsmeldinger sendes til tilbakekallet.",
  mqtt_disconnect: "Koble fra MQTT-klienten",
  mqtt_disconnect_tooltip: "Kobler MQTT-klienten fra serveren.",
  hcsr_init: "Start HCSR04 ultralydsensor",
  hcsr_timeout: "tidsavbrudd (us)",
  get_distance: "Les avstand (ultralydsensor)",
  measure_distance: "Mål avstand med ultralydsensoren",
  humidity: "fuktighet",
  init_sht20: "Initiere SHT20",
  aht_init: "Initiere AHT10/20",
  bh1750_init: "Initiere BH1750",
  line: "linje",
//Splash screen
