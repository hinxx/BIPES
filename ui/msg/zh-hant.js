...
//with no label at all.
  ...
  mqtt_callback_tooltip: "The callback function must take the topic and msg parameters.",
  with: "with",
  received_from: "received from",
  do: "do",
  mqtt_subscribe: "Subscribe to MQTT Topic",
  mqtt_check_msg: "Check for MQTT Server messages",
  mqtt_check_msg_tooltip: "Check whether the server has any pending messages. Non-blocking. Subscription messages are passed to the callback.",
  mqtt_wait_msg: "Wait for MQTT Server messages",
  mqtt_wait_msg_tooltip: "Wait until the server sends a message. Blocking. Subscription messages are passed to the callback.",
  mqtt_disconnect: "Disconnect MQTT Client",
  mqtt_disconnect_tooltip: "Disconnect the MQTT client from the server.",
  hcsr_init: "Start HCSR04 ultrasound sensor",
  hcsr_timeout: "timeout (us)",
  get_distance: "Get distance (ultrasound sensor)",
  measure_distance: "Measure distance with the ultrasound sensor",
