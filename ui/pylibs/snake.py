...
#
# Entry point:
#     run(oled, button, x0=28, y0=24, led=None)  - what the Play Snake block
#     calls. x0/y0 are the window's origin inside the 128x64 the display
#     claims to be.
#
# Controls:
...
def _quiet_the_robot():
    ...
    invaders.py and defender.py carry the same function. Three copies rather
