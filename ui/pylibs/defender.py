...
#
# Entry points:
#   run(oled, btn, x0=28, y0=24, led=None)  - what the Play Defender block calls.
...
# Exit: press RST, which reboots the board.
#
...
def _quiet_the_robot():
    ...
    invaders.py and snake.py carry the same function. Three copies rather
